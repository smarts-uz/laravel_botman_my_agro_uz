!function (t) {
    ...
    function g(t, e) {
        if (null !== t && void 0 !== t) if ("object" != typeof t && (t = [t]), r(t)) for (var n = 0, o = t.length; o > n; n++) e.call(null, t[n], n, t); else for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && e.call(null, t[i], i, t)
    }
    ...
    function o(t, e) {
        ...
        for (e && null != e.children && (k.length || k.push(e.children), delete e.children); k.length;) if ((o = k.pop()) && void 0 !== o.pop) for (a = o.length; a--;) k.push(o[a]); else "boolean" == typeof o && (o = null), (i = "function" != typeof t) && (null == o ? o = "" : "number" == typeof o ? o += "" : "string" != typeof o && (i = !1)), i && n ? s[s.length - 1] += o : s === D ? s = [o] : s.push(o), n = i;
        var c = new r;
    ...
    function d(t, e, n, r, o) {
        ...
        } else if ("list" !== e && "type" !== e && !o && e in t) h(t, e, null == r ? "" : r), null != r && !1 !== r || t.removeAttribute(e); else {
    ...
    function g(t, e, n, r, o) {
        ...
        if (0 !== x) for (var w = 0; x > w; w++) {
            u = e[w], p = null;
            var T = u.key;
            if (null != T) m && void 0 !== h[T] && (p = h[T], h[T] = void 0, m--); else if (!p && g > y) for (i = y; g > i; i++) if (void 0 !== d[i] && c(a = d[i], u, o)) {
    ...
    function C(t, e, n) {
        var r, o = F[t.name];
        if (t.prototype && t.prototype.render ? (r = new t(e, n), A.call(r, e, n)) : (r = new A(e, n), r.constructor = t, r.render = T), o) for (var i = o.length; i--;) if (o[i].constructor === t) {
    ...
    function M(t, e, n, r) {
        if (!t._disable) {
            ...
            if (!m || n ? R.unshift(t) : w || (t.componentDidUpdate && t.componentDidUpdate(f, d, h), E.afterUpdate && E.afterUpdate(t)), null != t._renderCallbacks) for (; t._renderCallbacks.length;) t._renderCallbacks.pop().call(t);
            L || r || y()
        }
    }
    ...
    var o = n(0), i = n(14), a = {"Content-Type": "application/x-www-form-urlencoded"}, s = {
        adapter: function () {
            var t;
    ...
    t.exports = function (t, e, n) {
        if (!e) return t;
        var i;
        if (n) i = n(e); else if (o.isURLSearchParams(e)) i = "" + e; else {
            var a = [];
    ...
    e.a = function (t) {
        ...
        return a(e, t), e.prototype.componentDidMount = function () {
            ...
            var n = this;
            return Object(r.b)("div", null, Object(r.b)("div", {id: "messageArea"}, Object(r.b)(o.a, {
                messages: e.messages,
            ...
            }, Object(r.b)("g", null, Object(r.b)("g", {id: "send"}, Object(r.b)("polygon", {points: "0,497.25 535.5,267.75 0,38.25 0,216.75 382.5,267.75 0,318.75"})))), Object(r.b)("textarea", {
                id: "userText",
                class: "textarea",
                placeholder: this.props.conf.placeholderText,
                ref: function (t) {
    ...
    e.a = function (t) {
        ...
        return i(e, t), e.prototype.render = function (t) {
            ...
            return Object(r.b)("ol", {class: "chat", style: e}, t.messages.map(function (e) {
    ...
    e.a = function (t) {
        ...
        return p(e, t), e.prototype.componentDidMount = function () {
            ...
            var e = new Date, n = t.message, a = new Date(n.time), s = l[n.type] || i.a, c = this.props,
                u = c.messageHandler, p = c.conf, f = "";
            ...
            return Object(r.b)("li", {
                ...
                class: n.from,
                style: f
            }, Object(r.b)("div", {class: "msg"}, Object(r.b)(s, {
    ...
    e.a = function (t) {
        ...
        return i(e, t), e.prototype.render = function (t) {
            var e = t.message, n = e.attachment, o = {__html: e.text};
            return Object(r.b)("div", null, Object(r.b)("p", {dangerouslySetInnerHTML: o}), n && "image" === n.type ? Object(r.b)("img", {
                src: n.url,
                style: "max-width: 100%;"
