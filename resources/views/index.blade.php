            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">@lang('analytics.select_view')</h1>
                                <div class="Titles-sub">@lang('analytics.various_visualizations')</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">@lang('analytics.this_vs_last_week')</h1>
                                <div class="Titles-sub">@lang('analytics.by_users')</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">@lang('analytics.this_vs_last_year')</h1>
                                <div class="Titles-sub">@lang('analytics.by_users')</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">@lang('analytics.top_browsers')</h1>
                                <div class="Titles-sub">@lang('analytics.by_pageview')</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">@lang('analytics.top_countries')</h1>
                                <div class="Titles-sub">@lang('analytics.by_sessions')</div>
                            </header>
