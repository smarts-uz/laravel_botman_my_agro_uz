...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i>@lang('generic.settings')
    </h1>
@stop
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            <strong>{{ trans('generic.how_to_use') }}:</strong>
            <p>{{ trans('settings.usage_help') }} <code>setting('group.key')</code></p>
        </div>
        @endif
    </div>
        ...
        <div class="panel" style="margin-top:10px;">
            ...
            <div class="panel-body">
                <form action="{{ route('voyager.settings.store') }}" method="POST">
                    ...
                    <input type="hidden" name="setting_tab" class="setting_tab" value="{{ $active }}" />
                    <div class="col-md-3">
                        <label for="display_name">@lang('generic.name')</label>
                        <input type="text" class="form-control" name="display_name" placeholder="@lang('settings.help_name')" required="required">
                    </div>
                    <div class="col-md-3">
                        <label for="key">@lang('generic.key')</label>
                        <input type="text" class="form-control" name="key" placeholder="@lang('settings.help_key')" required="required">
                    </div>
                    <div class="col-md-3">
                        <label for="type">@lang('generic.type')</label>
                        <select name="type" class="form-control" required="required">
                            <option value="">@lang('generic.choose_type')</option>
                            <option value="text">@lang('form.type_textbox')</option>
                            <option value="text_area">@lang('form.type_textarea')</option>
                            <option value="rich_text_box">@lang('form.type_richtextbox')</option>
                            <option value="code_editor">@lang('form.type_codeeditor')</option>
                            <option value="checkbox">@lang('form.type_checkbox')</option>
                            <option value="radio_btn">@lang('form.type_radiobutton')</option>
                            <option value="select_dropdown">@lang('form.type_selectdropdown')</option>
                            <option value="file">@lang('form.type_file')</option>
                            <option value="image">@lang('form.type_image')</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label for="group">@lang('settings.group')</label>
                    ...
                    <div class="col-md-12">
                        <a id="toggle_options"><i class="voyager-double-down"></i> @lang('generic.options')</a>
                        <div class="new-settings-options">
                            <label for="options">@lang('generic.options')
                                <small>@lang('settings.help_option')</small>
                            </label>
                            ...
                            <div id="valid_options" class="alert-success alert" style="display:none">@lang('json.valid')</div>
                            <div id="invalid_options" class="alert-danger alert" style="display:none">@lang('json.invalid')</div>
                        </div>
                    </div>
                    <div style="clear:both"></div>
                    <button type="submit" class="btn btn-primary pull-right new-setting-btn">
                        <i class="voyager-plus"></i> @lang('settings.add_new')
                    </button>
                    <div style="clear:both"></div>
                </form>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="@lang('generic.close')">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <h4 class="modal-title">
                        <i class="voyager-trash"></i>@lang('settings.delete_question', ['setting' => '<span id="delete_setting_title"></span>'])
                    </h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
                        <input type="submit" class="btn btn-danger pull-right delete-confirm" value="@lang('settings.delete_confirm')">
                    </form>
...
@section('javascript')
    ...
    $(".group_select_new").select2({
        tags: true,
        width: 'resolve',
        placeholder: '@lang("generic.select_group")'
    });
